...
class Cliente(db.Model, UserMixin):
    ...
    def __init__(self, nombre, apellido, documento, correo=None, telefono=None):
        self.nombre = nombre
    ...
    def update(self, nombre=None, apellido=None, documento=None, correo=None, telefono=None):
